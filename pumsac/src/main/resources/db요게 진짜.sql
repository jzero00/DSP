...
-- PRO_BOARDMASTER
INSERT INTO PRO_BOARDMASTER (PROJECTID, BOARDNAME, BOARDTYPE, FILEYN, REPLYYN, FILEDOWNLOADYN, REGISTER, REGDATE) VALUES (1, 'pms자료실', '자료실', 'y', 'y', 'y', 'DolphinShark@naver.com', SYSDATE);
-- off_schedule
...
INSERT INTO PRO_BOARDMASTER (PROJECTID, BOARDNAME, BOARDTYPE, FILEYN, REPLYYN, FILEDOWNLOADYN, REGISTER, REGDATE) VALUES ('1000', '공지사항', '공지', 'Y', 'N', 'Y', 'admin', sysdate);
