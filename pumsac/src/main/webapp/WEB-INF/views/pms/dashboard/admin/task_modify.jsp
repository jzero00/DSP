		...
		<div class="col-md-10" style="max-width:960px;">
			<div class="card card-info">
				...
				<div class="card-body pad">
					<form id="modifyForm" name="modifyForm" action="<%=request.getContextPath()%>/pms/admin/task/modify" role="form" method="post">
						...
						<c:if test="${sessionScope.loginUser.role ne 'ROLE_ADMIN'}">
						<input type="hidden" id="color" class="form-control" name="color" data-original-title="" title="" autocomplete="off" value="${detailPersonal.color}">
						</c:if>
						<div class="row">
						...
						<div class="row">
							...
							<div class="form-group col-sm-6">
								<label for="nickname">업무 받은사람</label>
						...
						<c:if test="${sessionScope.loginUser.role eq 'ROLE_ADMIN'}">
							<div class="col-sm-3">
								<div class="my-colorpicker2 colorpicker-element" data-colorpicker-id="2">
							 		...
							 		<div class="row">
								 		<div class="col-sm-12">
									 		<input type="color" id="color" class="form-control" name="color" data-original-title="" title="" autocomplete="off" value="${detailPersonal.color}">
								 		</div> 
									</div>
								</div>
							</div>
