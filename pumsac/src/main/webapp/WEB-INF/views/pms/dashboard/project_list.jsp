            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="right col-sm-2">
	                	<button type="button" class="btn btn-block bg-gradient-primary" onclick="endProgram();">DSP로 돌아가기</button>
                    </div>
                    <div class="right col-sm-10">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/pms/">PMS</a></li>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <form id="search" action="/pms/" method="post">
                        ...
                        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4 project" >
                            <div class="row">
			                    <c:forEach items="${projectList}" var="project">
	                                <div class="col-md-4">
	                                    <div class="card bg-primary" onclick="project_go('${project.PROJECTID}','${project.REGISTER }')">
	                                        ...
	                                        <!-- /.card-header -->
	                                        <div class="card-body">
	                                        관리자 : ${project.REGISTER}<br><br>
											<%-- 프로젝트 설명 : ${project.PROJECTEXPLAIN } --%>
	                                        <h6>시작일:<fmt:formatDate value="${project.STARTDATE}" pattern="yyyy-MM-dd"/></h6>
	                                        <h6>종료일:<fmt:formatDate value="${project.ENDDATE}" pattern="yyyy-MM-dd"/></h6>
	                                        </div>
	                                    </div>
									</div>
								</c:forEach>
...
<script type="text/javascript">
    ...
    function project_go(project_id, register){
		if('${loginUser.email}' === register){
	    	location.href="<%=request.getContextPath()%>/pms/admin/main?projectId="+project_id;
		} else {
	    	location.href="<%=request.getContextPath()%>/pms/user/main?projectId="+project_id;
		}
    }
