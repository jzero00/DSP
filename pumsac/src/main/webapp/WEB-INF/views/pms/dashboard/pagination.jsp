...
<form id="jobForm">
	...
	<input type='hidden' name="projectId" value="${pageMaker.cri.projectId}" />
</form>
...
function searchList_go(page){
	...
	var jobForm=$('#jobForm');
 	...
 	jobForm.find("[name='keyword']").val($('form.form-inline>input[name="keyword"]').val());	
	

	jobForm.attr("action","regist");
