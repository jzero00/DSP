		...
		<div class="col-md-10" style="max-width:960px;">
			<div class="card card-info">
				...
				<div class="card-body pad">
					<form id="registForm" name="registForm" role="form" method="post">
						...
						<div class="row">
							...
							<div class="form-group col-sm-4">
								...
								<input type="text" class="form-control" id="email" value="${plan.memberNickName}" readonly="readonly">
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							...
							<div class="col-sm-3">
								...
								<select class="form-control" name="alarmTime" disabled>
