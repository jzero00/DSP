...
<body>
	<div class="wrapper">
		<div class="container">
			<div class="row">
				<div class="col-2">
					<button type="button" class="btn btn-block bg-gradient-info" onclick="location.href='${pageContext.request.contextPath}/pms/user/main?projectId=${projectId}'">
						<i class="fas fa-long-arrow-alt-left"></i>대시보드로 가기
					</button>
				</div>
				<div class="col-2">
					<button type="button" class="btn btn-block bg-gradient-info" onclick="location.href='list?projectId=${projectId}'">
