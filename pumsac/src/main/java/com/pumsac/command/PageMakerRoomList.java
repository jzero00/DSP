...
public class PageMakerRoomList {
	...
	private CriteriaRoomList cri; //현재 페이지 정보
	...
	public CriteriaRoomList getCri() {
		return cri;
	}

	public void setCri(CriteriaRoomList cri) {
		this.cri = cri;
	}
