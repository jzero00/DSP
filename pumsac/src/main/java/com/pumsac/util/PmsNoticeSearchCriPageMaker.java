...
public class PmsNoticeSearchCriPageMaker {
	...
	private PmsNoticeSearchCri cri; // 현재 페이지 정보
	...
	public PmsNoticeSearchCri getCri() {
		return cri;
	}

	public void setCri(PmsNoticeSearchCri cri) {
		this.cri = cri;
	}
	...
	public String makeQuery() {
		String query = "?page=" + cri.getPage() + "&perPageNum=" + cri.getPerPageNum() + "&searchType="
